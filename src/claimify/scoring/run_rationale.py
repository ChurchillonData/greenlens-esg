...
Usage:
    python -m claimify.scoring.run_rationale                      # all scored claims
    python -m claimify.scoring.run_rationale --eval-only          # eval-set claims only
    python -m claimify.scoring.run_rationale --claims-file PATH   # custom claim list
...
from claimify.scoring.llm_scorer import get_client
from claimify.scoring.rationale_generator import generate_rationale
