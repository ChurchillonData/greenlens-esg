...
Run as a script:
    python -m claimify.ingestion.fetch_ngo           # fetch live content
    python -m claimify.ingestion.fetch_ngo --dry-run # save titles only, no network
"""
...
from claimify.ingestion.fetch_web import fetch_text
